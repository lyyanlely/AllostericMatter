%function allostery(replica, xl, yl, nsp, beta_ini)
replica = 1;
xl    = 12;
yl    = 12;
nsp   = 360;%
...
id  = (1:np)+4;     % indices of the displaced particles
idd = (1:dim*np)+8;  %
it  = (yl-1)*xl+(1:nt)+4;  % indices of the target particles
...
bondnb = bondnb(1:nnb,:);
for i = 1:num
    nbsite{i} = find(sum(bondnb==i,2)>0);
end
bondwk = bondwk(1:nwk,:);
fixs   = fixs(1:cf);
pert(2*id(1)) = -1*dd;
    ...
    for tt = 1:temprange
        ...
        for ii = 1:paraiter
            ...
            if mod(ii,interv)==0
                ...
                %estr(ii/interv)    = force.^2/2;
                %ewk(ii/interv)     = fweak.^2/2;
...
costname = [dirc,cname '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(costname, cdata, '\t');
prname = [dirc,pname '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(prname, pdata, '\t');
mzname = [dirc,zname '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(mzname, zdata, '\t');
esname = [dirc,esnam '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(esname, estim, '\t');
etname = [dirc,etnam '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(etname, etarg, '\t');
stname = [dirc,stnam '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
...
dlmwrite(ewknme, ewk, '\t');
plname = [dirc,ppnam '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(plname, ploc, '\t');
zlname = [dirc,zznam '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(zlname, zloc, '\t');
bfname = [dirc,bfnam '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(bfname, bfact, '\t');
sfname = [dirc,sfnam '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(sfname, sfact, '\t');
ncname = [dirc,ncnam '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(ncname, cloc, '\t');
cfname = [dirc,sname '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
dlmwrite(cfname, resps, '\t');
cfname = [dirc,svnam '_' xname '_' yname '_' nsname '_' dname '_' tname '_' bname '_' wfname '_' exname '.dat'];
